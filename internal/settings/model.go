...
const (
	...
	GatewayVisionEnabled        = "gateway.vision_enabled"
...
var Defs = []KeyDef{
	...
	{Key: GatewayVisionEnabled, Type: "bool", Category: "gateway", Default: "false", Label: "图片输入(vision)", Desc: "开启后 /v1/chat/completions 的 image_url 会上传为上游附件。该通路未经抓包实证,开启前请按 docs/spec/vision.md 验证"},
