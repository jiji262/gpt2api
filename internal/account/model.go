...
type Account struct {
	...
	// AutoDeleteConversation 为 true 时,生图成功后自动向 chatgpt.com 发
	// PATCH /backend-api/conversation/{id} {"is_visible": false},等价于用户在
	// 网页端点"删除",使该对话从 chatgpt.com 左侧列表消失。
	AutoDeleteConversation bool         `db:"auto_delete_conversation" json:"auto_delete_conversation"`
